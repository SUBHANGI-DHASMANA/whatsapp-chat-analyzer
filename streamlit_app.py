...
uploaded_file = st.sidebar.file_uploader("Upload whatsapp txt file in 24hr format")
if uploaded_file is not None:
    ...
    if st.sidebar.button("Show analysis"):
        ...
        with col2:
            top_5_emojis = emoji_df.sort_values(by=1, ascending=False).head(5)
            fig, ax = plt.subplots()
            ax.bar(top_5_emojis[0], top_5_emojis[1])
